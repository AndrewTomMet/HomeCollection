        ...
        $formMapper
            ->tab('Інформація')
                ->with('Офіційна', ['class' => 'col-md-4'])
                    ...
                    ->add('nameUkr')
                    ->add('year')
                    ->add('itemType', 'entity', ['class' => 'AppBundle\Entity\ItemType', 'multiple' => true, 'required' => false] )
                    ->add('translation', 'entity', ['class' => 'AppBundle\Entity\Translation', 'multiple' => true, 'required' => false] )
